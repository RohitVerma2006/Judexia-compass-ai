      ...
      <div className="hidden lg:flex lg:w-1/2 relative items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 p-12 max-w-md">
          <h1 className="font-serif text-4xl font-bold text-foreground mb-4">
            {t('trainLegalMind').split(' ').slice(0, 3).join(' ')}{' '}
            <span className="text-gold">{t('trainLegalMind').split(' ').slice(3).join(' ')}</span>
          </h1>
          <p className="text-muted-foreground text-lg">{t('aiPowered')}</p>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
        <div className="glass-card-gold p-8 w-full max-w-md animate-fade-in">
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            <h2 className="font-serif text-2xl font-bold text-foreground">{t('welcomeBack')}</h2>
