...
const Login = () => {
  ...
  const handleGoogleSignIn = () => {
    ...
    signup(mockGoogleUser.fullName, mockGoogleUser.email, 'google-oauth');
    navigate('/dashboard');
  };
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
        <div className="glass-card-gold p-8 w-full max-w-md animate-fade-in">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-4 py-2.5 rounded-lg border border-border/50 bg-white/5 hover:bg-white/10 transition-all duration-200 group"
          >
            ...
            <span className="ml-auto text-[10px] text-muted-foreground/50 italic">Prototype Simulation</span>
          </button>
